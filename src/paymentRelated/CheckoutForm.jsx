...
const CheckoutForm = ({price,selected}) => {
    ...
    const handleSubmit = async (event) => {
      ...
      if(paymentIntent.status==='succeeded'){
        ...
        const payment={
            ...
            classItems:selected.map(item=>item.id),
    ...
    {transectionId && <p className="text-1xl">Your transection id is: <span className="text-blue-500 font-bold ">{transectionId}</span></p>}
       </>
    );
};
